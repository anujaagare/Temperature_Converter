...
document.querySelector(".btn").addEventListener("click", function (e) {
    ...
    const inputTempValue = document.querySelector(".inputtemp").value;
    const inputTempUnit = document.querySelector(".choose").value;
    const convertToUnit = document.querySelector(".choosen").value;
    ...
    document.querySelector(".result").textContent = `${result % 1 === 0 ? result : result.toFixed(2)
